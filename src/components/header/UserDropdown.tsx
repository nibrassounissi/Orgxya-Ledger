...
export default function UserDropdown({
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="me-3 flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-brand-500 text-sm font-semibold text-white">
          {initials}
        </span>

        <span className="me-1 block text-theme-sm font-medium">{email}</span>

        <span
          className={`inline-flex size-5 text-gray-500 transition-transform duration-200 dark:text-gray-400 ${
            isOpen ? "rotate-180" : ""
          }`}
        >
          <ChevronDownIcon />
      ...
      >
        ...
        <form onSubmit={handleLogout} className="mt-3">
          <button
            ...
            className="group flex w-full items-center justify-center gap-3 rounded-lg border border-gray-200 px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
          >
